 ...
 * pago (Efectivo / Tarjeta / Código QR), E carga el monto exacto en efectivo,
 * Escape retrocede un paso en el checkout y Espacio repite el "Nueva Venta"
 * de la pantalla de éxito. Mismo patrón que useScannerInput.ts: listener
 * único en window, con guardas de foco para no interferir con inputs de
 * texto. `onEscape` decide qué significa "retroceder" según el estado —
 * esa lógica vive en el componente porque depende de campos de Posnet/QR
 * que este hook no necesita conocer.
 */
