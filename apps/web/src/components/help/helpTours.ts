  ...
  },
  {
    ...
    steps: [
      ...
      step({
        ...
        body: "Tocá Nuevo producto para abrir el formulario a la derecha. Completá nombre y precio como mínimo. La categoría es opcional.",
        icon: "wine",
        advanceOnClick: true,
      }),
      step({
        ...
        title: "Formulario del producto",
        body: "Nombre, precio, descripción, categoría e imagen o ícono. También podés marcarlo como promoción o trending. Guardar crea el producto; la X cierra sin cambios.",
        icon: "wine",
        scrollFeel: true,
      }),
      step({
