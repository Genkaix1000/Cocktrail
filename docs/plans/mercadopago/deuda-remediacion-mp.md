...
- [PR3] **A17 reapareció**: al 2026-07-21 hay **2 sellers activos** en Cloud (`1517393956` GARCIAMANUEL del 20/07 18:38 y `225043369` ASMA4106894 del 20/07 21:12, que se había borrado a mano y volvió a vincularse). Hoy el cobro usa el esperado solo por casualidad: `findFirstActive` toma el más viejo y ese resulta ser la cuenta de prueba de Manuel (la misma del `MP_ACCESS_TOKEN` del `.env`). **La cuenta del dueño del boliche todavía no se vinculó nunca.** Confirma la urgencia de D9 (vincular reemplaza + Desvincular) en el PR 4.
