...
- **Criterios cumplidos**: los bloques A, B, E y F completos (A6 quedó cerrado por construcción con D1 en el PR 4). Quedan C (→ PR 5) y D/G/H (→ PR 6).
